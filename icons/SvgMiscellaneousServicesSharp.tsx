// /src/maps/miscellaneous_services/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMiscellaneousServicesSharp = createSvgIcon(
