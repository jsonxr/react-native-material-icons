// /src/social/person_remove_alt_1/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPersonRemoveAlt1Twotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M10,16c2.69,0,5.77,1.28,6,2H4C4.2,17.29,7.3,16,10,16z" opacity=".3"/>
