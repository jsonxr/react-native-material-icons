// /src/maps/tire_repair/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgTireRepairTwotone = createSvgIcon(
