// /src/social/sports_mma/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSportsMmaTwotone = createSvgIcon(
