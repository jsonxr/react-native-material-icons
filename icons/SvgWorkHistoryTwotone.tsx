// /src/action/work_history/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgWorkHistoryTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M4,8v11h7.08C11.03,18.67,11,18.34,11,18c0-3.87,3.13-7,7-7c0.7,0,1.37,0.1,2,0.29V8H4z" opacity=".3"/>
