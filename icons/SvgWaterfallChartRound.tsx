// /src/navigation/waterfall_chart/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgWaterfallChartRound = createSvgIcon(
