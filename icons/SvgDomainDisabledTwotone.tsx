// /src/communication/domain_disabled/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDomainDisabledTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    ...
    <path d="M12 9v.45l8 8V9h-8zm6 4h-2v-2h2v2z" opacity=".3"/>
  </svg>`
);
