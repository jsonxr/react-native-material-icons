// /src/social/sanitizer/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSanitizerTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M10,8c-2.21,0-4,1.79-4,4v8h8v-8C14,9.79,12.21,8,10,8z M13,16h-2v2H9v-2H7v-2h2v-2h2v2h2V16z" opacity=".3"/>
