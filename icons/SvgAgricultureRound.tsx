// /src/maps/agriculture/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgAgricultureRound = createSvgIcon(
