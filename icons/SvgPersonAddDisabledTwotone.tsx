// /src/communication/person_add_disabled/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPersonAddDisabledTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0z" fill="none"/>
    <path d="M9 18h5.87L13 16.13l-1.1.3C9.89 16.99 9.08 17.76 9 18zm8-10c0-1.1-.9-2-2-2-.99 0-1.81.72-1.97 1.67l2.31 2.31C16.27 9.82 17 8.99 17 8z" opacity=".3"/>
