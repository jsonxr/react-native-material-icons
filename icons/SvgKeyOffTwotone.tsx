// /src/communication/key_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgKeyOffTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g opacity=".3">
        <path d="M10.7,13.53l-1.71-1.71C9,11.88,9,11.94,9,12c0,1.1-0.9,2-2,2s-2-0.9-2-2s0.9-2,2-2c0.06,0,0.12,0,0.18,0.01L5.47,8.3 C4.02,8.9,3,10.33,3,12c0,2.21,1.79,4,4,4C8.67,16,10.1,14.98,10.7,13.53z M16.26,13.43l1.24-0.93l1.81,1.36L21.17,12l-1-1 l-6.34,0L16.26,13.43z"/>
      </g>
      <g>
