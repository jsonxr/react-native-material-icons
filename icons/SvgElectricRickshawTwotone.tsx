// /src/maps/electric_rickshaw/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgElectricRickshawTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <g>
          <path d="M3,13h0.17C3.58,11.84,4.7,11,6,11c0.35,0,0.69,0.06,1,0.17V10H3V13z" enable-background="new" opacity=".3"/>
          <path d="M19,11h-3v2h1.17c0.3-0.85,0.98-1.53,1.83-1.83V11z" enable-background="new" opacity=".3"/>
