// /src/image/rotate_90_degrees_cw/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgRotate90DegreesCwTwotone = createSvgIcon(
    ...
    <g>
      <g>
        <g>
          ...
          <rect enable-background="new" height="4.49" opacity=".3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -4.2138 15.8229)" width="4.49" x="14.75" y="10.75"/>
        </g>
      </g>
    </g>
  </svg>`
