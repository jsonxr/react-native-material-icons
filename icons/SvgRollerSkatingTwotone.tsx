// /src/social/roller_skating/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgRollerSkatingTwotone = createSvgIcon(
