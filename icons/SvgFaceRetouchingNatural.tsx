...
export const SvgFaceRetouchingNatural = createSvgIcon({
  ...
  twotone: `
    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
        ...
        <g>
            <g>
                <path d="M10.66,4.12c2.55,4.23,7.03,3.87,7.18,3.86l-0.57-1.25L12.4,4.5l0.85-0.39C12.84,4.04,12.43,4,12,4 C11.54,4,11.09,4.05,10.66,4.12z" opacity=".3"/>
                <path d="M8.08,5.03C6.37,6,5.05,7.58,4.42,9.47C6.13,8.5,7.45,6.92,8.08,5.03z" opacity=".3"/>
                ...
                <circle cx="9" cy="13" r="1.25"/>
                <circle cx="15" cy="13" r="1.25"/>
                <polygon points="20.6,3.4 19.5,1 18.4,3.4 16,4.5 18.4,5.6 19.5,8 20.6,5.6 23,4.5"/>
            </g>
        </g>
    </svg>`
});
