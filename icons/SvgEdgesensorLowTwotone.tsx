// /src/device/edgesensor_low/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgEdgesensorLowTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <rect height="7" width="2" x="20" y="10"/>
        <rect height="7" width="2" x="2" y="7"/>
