// /src/device/pattern/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPatternOutlined = createSvgIcon(
