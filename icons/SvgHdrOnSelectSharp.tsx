// /src/device/hdr_on_select/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgHdrOnSelectSharp = createSvgIcon(
