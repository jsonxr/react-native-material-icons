// /src/image/face_retouching_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgFaceRetouchingOffTwotone = createSvgIcon(
