// /src/image/video_stable/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgVideoStableTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect height="8.86" opacity=".3" transform="matrix(0.2589 -0.9659 0.9659 0.2589 -2.6958 20.4865)" width="5.1" x="9.45" y="7.57"/>
