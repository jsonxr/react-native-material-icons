// /src/av/interpreter_mode/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgInterpreterModeTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M15.52,15.01C15.35,15,15.18,15,15,15c-2.37,0-4.29,0.73-5.48,1.34C9.2,16.5,9,16.84,9,17.22V18l7.17,0 C15.74,17.26,15.4,16.24,15.52,15.01z M13,8c0,1.1,0.9,2,2,2s2-0.9,2-2c0-1.1-0.9-2-2-2S13,6.9,13,8z" opacity=".3"/>
