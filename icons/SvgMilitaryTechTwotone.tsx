// /src/social/military_tech/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMilitaryTechTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <polygon opacity=".3" points="13,11.07 15,9.87 15,4 13,4"/>
        <polygon opacity=".3" points="9,4 9,9.87 11,11.07 11,4"/>
