// /src/communication/stop_screen_share/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgStopScreenShareTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0z" fill="none"/>
    <path d="M10.67 12.54C9.13 12.92 7.96 13.71 7 15c.31-1.48.94-2.93 2.08-4.05L4.13 6.02H4v10.01h10.14l-3.47-3.49z" opacity=".3"/>
    ...
    <path d="M20 6.02H9.8l3.13 3.13c.02 0 .04-.01.07-.02V7l4 3.73-1.28 1.2L20 16.21V6.02z" opacity=".3"/>
  </svg>`
);
