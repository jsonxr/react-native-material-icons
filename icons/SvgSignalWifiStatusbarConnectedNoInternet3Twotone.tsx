// /src/device/signal_wifi_statusbar_connected_no_internet_3/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSignalWifiStatusbarConnectedNoInternet3Twotone = createSvgIcon(
