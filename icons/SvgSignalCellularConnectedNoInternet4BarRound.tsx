// /src/device/signal_cellular_connected_no_internet_4_bar/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSignalCellularConnectedNoInternet4BarRound = createSvgIcon(
