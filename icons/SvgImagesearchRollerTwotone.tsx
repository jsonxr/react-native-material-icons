// /src/notification/imagesearch_roller/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgImagesearchRollerTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect enable-background="new" height="2" opacity=".3" width="10" x="8" y="4"/>
        <rect enable-background="new" height="4" opacity=".3" width="2" x="12" y="17"/>
