// /src/places/no_backpack/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgNoBackpackTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24" y="0"/>
    <path d="M18,15.17V8c0-1.1-0.9-2-2-2H8.83l6,6h1.67v1.67L18,15.17z M17.17,20l-6-6H7.5v-2h1.67L6,8.83V20H17.17z" opacity=".3"/>
