// /src/image/control_point_duplicate/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgControlPointDuplicateTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0z" fill="none"/>
    <path d="M15 5c-3.86 0-7 3.14-7 7s3.14 7 7 7 7-3.14 7-7-3.14-7-7-7zm4 8h-3v3h-2v-3h-3v-2h3V8h2v3h3v2z" opacity=".3"/>
