// /src/notification/phone_locked/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPhoneLockedTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <g>
          <path d="M15,17.83c1.29,0.54,2.63,0.89,4,1.07v-2.23l-2.35-0.47L15,17.83z" enable-background="new" opacity=".3"/>
          <path d="M7.33,5H5.1c0.18,1.37,0.53,2.7,1.07,4L7.8,7.35L7.33,5z" enable-background="new" opacity=".3"/>
