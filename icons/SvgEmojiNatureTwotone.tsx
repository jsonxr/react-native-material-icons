// /src/social/emoji_nature/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgEmojiNatureTwotone = createSvgIcon(
