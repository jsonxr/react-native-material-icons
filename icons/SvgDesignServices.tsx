  ...
  twotone: `
    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
        ...
        <g>
            <g/>
            <g>
                <polygon opacity=".3" points="15.91,9.28 14.61,7.98 5,17.59 5,19 6.41,19 16.02,9.39"/>
                <polygon opacity=".3" points="10.83,8.93 9.63,7.73 8.44,8.92 7.02,7.5 8.21,6.32 6.94,5.04 6.94,5.04 5.04,6.94 8.93,10.83"/>
                <polygon opacity=".3" points="16.27,14.38 15.07,13.17 13.17,15.07 17.06,18.96 18.96,17.06 17.69,15.79 16.5,16.98 15.08,15.57"/>
                <rect height="2" opacity=".3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 0.4645 14.2513)" width="2" x="16.44" y="5.56"/>
