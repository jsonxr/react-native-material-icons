// /src/places/do_not_step/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDoNotStepTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <rect fill="none" height="24" width="24"/>
      <path d="M14.98,12.15 M14.98,12.15l3.07-3.07L13.8,4.82l-3.08,3.07L14.98,12.15z M12.42,15.26l-1.67-1.68L7.42,16.9 c-0.78,0.78-2.05,0.78-2.83-0.01L4.4,16.72l-0.47,0.24c-0.29,0.14-0.59,0.27-0.89,0.39L3.03,18h6.64L12.42,15.26z" opacity=".3"/>
