// /src/action/hotel_class/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgHotelClassTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <polygon opacity=".3" points="11,8.89 11.94,12 14.76,12 12.49,13.62 13.42,16.63 11,14.79 8.58,16.63 9.51,13.62 7.24,12 10.06,12"/>
