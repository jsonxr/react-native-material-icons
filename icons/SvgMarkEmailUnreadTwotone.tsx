// /src/communication/mark_email_unread/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMarkEmailUnreadTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <rect fill="none" height="24" width="24" x="0"/>
      <path d="M4,6h10.1c0.22,1.07,0.79,2,1.57,2.71L12,11L4,6z M4,8v10h16V9.9c-0.32,0.07-0.66,0.1-1,0.1 c-0.6,0-1.16-0.12-1.7-0.32L12,13L4,8z" opacity=".3"/>
