// /src/social/recommend/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgRecommendTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M12,4c-4.41,0-8,3.59-8,8s3.59,8,8,8s8-3.59,8-8S16.41,4,12,4z M17.9,12.3 l-2.1,4.9c-0.22,0.51-0.74,0.83-1.3,0.8H9c-1.1,0-2-0.9-2-2v-5c-0.02-0.38,0.13-0.74,0.4-1L12,5l0.69,0.69 c0.18,0.19,0.29,0.44,0.3,0.7v0.2L12.41,10H17c0.55,0,1,0.45,1,1v0.8C18.02,11.97,17.98,12.15,17.9,12.3z" enable-background="new" opacity=".3"/>
