// /src/action/send_and_archive/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSendAndArchiveTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <g opacity=".3">
          <path d="M5,7.01v3.49l6,1.5l-6,1.5v3.49l5.39-2.27l0,0c0.6-1.74,1.86-3.16,3.48-3.97c0,0,0,0,0,0L5,7.01z"/>
        </g>
        <g>
