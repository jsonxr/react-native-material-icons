// /src/social/person_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPersonOffTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M15.17,18l-3-3c-0.06,0-0.11,0-0.17,0c-2.37,0-4.29,0.73-5.48,1.34C6.2,16.5,6,16.84,6,17.22V18H15.17z M10.13,7.3C10.41,6.54,11.14,6,12,6c1.1,0,2,0.9,2,2c0,0.86-0.54,1.59-1.3,1.87" opacity=".3"/>
