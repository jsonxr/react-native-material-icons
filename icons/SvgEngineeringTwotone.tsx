// /src/social/engineering/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgEngineeringTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M9,11c1.1,0,2-0.9,2-2H7C7,10.1,7.9,11,9,11z" opacity=".3"/>
        <path d="M7.5,6C7.78,6,8,5.78,8,5.5V4.14C7.64,4.23,7.31,4.37,7,4.55V5.5C7,5.78,7.22,6,7.5,6z" opacity=".3"/>
        <path d="M10.5,6C10.78,6,11,5.78,11,5.5V4.55c-0.31-0.18-0.64-0.32-1-0.41V5.5C10,5.78,10.22,6,10.5,6z" opacity=".3"/>
        <path d="M9,17c-2.69,0-5.77,1.28-6,2h12C14.8,18.29,11.7,17,9,17z" opacity=".3"/>
