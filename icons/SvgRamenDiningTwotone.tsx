// /src/maps/ramen_dining/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgRamenDiningTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M8.73,18.39l1.27,0.5V20h4v-1.11l1.27-0.5c2.16-0.85,3.74-2.47,4.4-4.39H4.34 C4.99,15.92,6.58,17.54,8.73,18.39z" enable-background="new" opacity=".3"/>
