// /src/action/edit_off/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgEditOffRound = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <g>
          <rect height="5.3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -2.2957 13.1079)" width="3.56" x="12.89" y="6.67"/>
        </g>
      </g>
    </g>
  </svg>`
