// /src/device/medication_liquid/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMedicationLiquidTwotone = createSvgIcon(
    ...
    <g>
      <g>
        <g>
          <g opacity=".3">
            <defs>
              <rect height="11" id="SVGID_1_" opacity=".3" width="10" x="4" y="8"/>
            </defs>
            <use overflow="visible" xlink:href="#SVGID_1_"/>
            <clipPath id="SVGID_2_">
              <use overflow="visible" xlink:href="#SVGID_1_"/>
            </clipPath>
            <path clip-path="url(#SVGID_2_)" d="M4,19h10V8H4V19z M5,12h2.5V9.5h3V12H13v3h-2.5v2.5h-3V15H5V12z"/>
          </g>
          <rect height="2" width="12" x="3" y="3"/>
          <path d="M14,6H4C2.9,6,2,6.9,2,8v11c0,1.1,0.9,2,2,2h10c1.1,0,2-0.9,2-2V8C16,6.9,15.1,6,14,6 M14,19H4V8h10V19z"/>
