// /src/maps/home_repair_service/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgHomeRepairServiceTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      ...
      <g>
        <g opacity=".3">
          <polygon points="18,16 16,16 16,15 8,15 8,16 6,16 6,15 4,15 4,18 20,18 20,15 18,15"/>
        </g>
        <g opacity=".3">
