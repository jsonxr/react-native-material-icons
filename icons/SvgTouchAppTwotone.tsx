// /src/action/touch_app/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgTouchAppTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <path d="M17.3,14.23l-3.46-1.73h-1.77v-6c0-0.28-0.22-0.5-0.5-0.5 c-0.28,0-0.5,0.22-0.5,0.5v10.61l-4.25-0.89l3.68,3.68c0.06,0.06,0.15,0.1,0.24,0.1h6.3l0.8-4.71 C17.91,14.86,17.69,14.43,17.3,14.23z" enable-background="new" opacity=".3"/>
      </g>
    </g>
  </svg>`
);
