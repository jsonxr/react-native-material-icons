// /src/device/signal_wifi_statusbar_connected_no_internet_1/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSignalWifiStatusbarConnectedNoInternet1Twotone = createSvgIcon(
