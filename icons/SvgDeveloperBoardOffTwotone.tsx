// /src/hardware/developer_board_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDeveloperBoardOffTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M4,19V6.83l2,2V12h3.17l1,1H6v4h5v-3.17l1,1V17h2.17l2,2H4z M16,13.17V11h-2.17l-1-1H16V7h-4v2.17l-1-1V7 H9.83l-2-2H18v10.17L16,13.17z" opacity=".3"/>
