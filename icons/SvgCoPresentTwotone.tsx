// /src/communication/co_present/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgCoPresentTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <g opacity=".3">
          <path d="M14.48,18.34C13.29,17.73,11.37,17,9,17c-2.37,0-4.29,0.73-5.48,1.34C2.9,18.66,3,19.28,3,20h12 C15,19.29,15.11,18.66,14.48,18.34z"/>
        </g>
        <g>
