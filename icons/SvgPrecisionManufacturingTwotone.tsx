// /src/social/precision_manufacturing/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPrecisionManufacturingTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <polygon opacity=".3" points="6.71,10 9.17,18 11.11,18 6.81,10"/>
        <circle cx="6" cy="7" opacity=".3" r="1"/>
