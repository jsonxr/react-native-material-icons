// /src/action/tips_and_updates/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgTipsAndUpdatesTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24" y="0"/>
    <path d="M14.5,9.5C14.5,6.47,12.03,4,9,4S3.5,6.47,3.5,9.5c0,2.47,1.49,3.89,2.35,4.5h6.3 C13.01,13.39,14.5,11.97,14.5,9.5z" opacity=".3"/>
