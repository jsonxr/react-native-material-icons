// /src/device/wifi_tethering_off/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgWifiTetheringOffOutlined = createSvgIcon(
