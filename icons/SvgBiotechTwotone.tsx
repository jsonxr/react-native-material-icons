// /src/content/biotech/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgBiotechTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect height="5" opacity=".3" transform="matrix(0.9397 -0.342 0.342 0.9397 -1.6091 4.9556)" width="1" x="12.75" y="4.54"/>
        <circle cx="10.5" cy="8" opacity=".3" r="1"/>
