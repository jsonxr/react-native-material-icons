// /src/action/edit_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgEditOffTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <path d="M0,0h24v24H0V0z" fill="none"/>
    </g>
    <g>
      <path d="M5,18.08V19h0.92l5.12-5.12l-0.92-0.92L5,18.08z M14.06,9.02l-1.11,1.11l0.92,0.92l1.11-1.11L14.06,9.02z" opacity=".3"/>
      <g>
