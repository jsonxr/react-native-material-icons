// /src/action/view_compact_alt/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgViewCompactAltTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M4,18h16V6H4V18z M12.5,7.5h4v4h-4V7.5z M12.5,12.5h4v4h-4V12.5z M7.5,7.5h4v4h-4V7.5z M7.5,12.5h4v4h-4 V12.5z" opacity=".3"/>
