// /src/device/media_bluetooth_off/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMediaBluetoothOffOutlined = createSvgIcon(
