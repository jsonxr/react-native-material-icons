// /src/social/vaccines/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgVaccinesTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M19,17h-4v-1.5h4V17z M9,7.5H5V15h4l0-1.5H7.25c-0.41,0-0.75-0.34-0.75-0.75C6.5,12.34,6.84,12,7.25,12H9 v-1.5H7.25c-0.41,0-0.75-0.34-0.75-0.75C6.5,9.34,6.84,9,7.25,9H9V7.5z" opacity=".3"/>
