// /src/search/garage/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgGarageTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M17,11.51V11.5H7v0.01v2.99h10V11.51z M9,14c-0.55,0-1-0.45-1-1s0.45-1,1-1c0.55,0,1,0.45,1,1S9.55,14,9,14 z M15,14c-0.55,0-1-0.45-1-1s0.45-1,1-1c0.55,0,1,0.45,1,1S15.55,14,15,14z" opacity=".3"/>
        <path d="M4,20h16V4H4V20z M5,11.19C5.82,8.72,6.34,7.16,6.56,6.5c0.05-0.16,0.12-0.29,0.19-0.4 C6.77,6.08,6.78,6.06,6.8,6.04C7.18,5.51,7.72,5.5,7.72,5.5h8.56c0,0,0.54,0.01,0.92,0.53c0.02,0.03,0.03,0.05,0.05,0.07 c0.07,0.11,0.14,0.24,0.19,0.4c0.22,0.66,0.74,2.23,1.56,4.69v6.5c0,0.45-0.35,0.81-0.78,0.81h-0.44c-0.44,0-0.78-0.36-0.78-0.81 V16.5H7v1.19c0,0.45-0.35,0.81-0.78,0.81H5.78C5.35,18.5,5,18.14,5,17.69V11.19z" opacity=".3"/>
