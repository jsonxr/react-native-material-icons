// /src/av/video_settings/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgVideoSettingsSharp = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <polygon points="3,6 21,6 21,11 23,11 23,4 1,4 1,20 12,20 12,18 3,18"/>
