// /src/image/panorama_horizontal/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPanoramaHorizontalTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0z" fill="none"/>
    <path d="M4 6.54v10.91c2.6-.77 5.28-1.16 8-1.16s5.4.39 8 1.16V6.54c-2.6.78-5.28 1.17-8 1.16-2.72 0-5.4-.39-8-1.16z" opacity=".3"/>
