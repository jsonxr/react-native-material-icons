// /src/social/thunderstorm/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgThunderstormOutlined = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <polygon points="14.8,17 11.9,20.32 13.9,21.32 11.55,24 14.2,24 17.1,20.68 15.1,19.68 17.45,17"/>
        <polygon points="8.8,17 5.9,20.32 7.9,21.32 5.55,24 8.2,24 11.1,20.68 9.1,19.68 11.45,17"/>
      </g>
    </g>
  </svg>`
);
