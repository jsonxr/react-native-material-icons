// /src/home/wind_power/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgWindPowerTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <circle cx="13" cy="13" opacity=".3" r="1"/>
        <path d="M3.28,13C3.13,13,3,13.13,3,13.28c0,0.12,0.08,0.24,0.2,0.27l4.51,1.29l2.33-1.4 c-0.02-0.15-0.03-0.29-0.03-0.44H3.28z" opacity=".3"/>
        <path d="M17.76,3.54c-0.15-0.09-0.29-0.01-0.34,0.04L14,6.78v3.36l0.11,0.03l3.74-6.24 C17.94,3.79,17.89,3.62,17.76,3.54z" opacity=".3"/>
        <path d="M18.19,15.48l-2.78-0.69c-0.07,0.1-0.15,0.19-0.24,0.28l4.85,4.85c0.16,0.16,0.35,0.05,0.4,0 c0.09-0.09,0.11-0.23,0.05-0.33L18.19,15.48z" opacity=".3"/>
