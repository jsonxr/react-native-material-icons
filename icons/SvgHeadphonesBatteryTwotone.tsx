// /src/hardware/headphones_battery/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgHeadphonesBatteryTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <g>
          <rect height="7" opacity=".3" width="2" x="18" y="9"/>
