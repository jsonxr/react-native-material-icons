// /src/hardware/router/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgRouterTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0zm0 0h24v24H0V0z" fill="none"/>
    <path d="M15 15H5v4h14v-4h-4zm-7 3H6v-2h2v2zm3.5 0h-2v-2h2v2zm3.5 0h-2v-2h2v2z" opacity=".3"/>
