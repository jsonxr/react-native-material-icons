// /src/file/folder_delete/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgFolderDeleteTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <rect fill="none" height="24" width="24"/>
    </g>
    <g>
      <path d="M14.5,11.5h2v4h-2V11.5z M20,8v10H4V6h5.17l2,2H20z M19,10h-2.5V9h-2v1H12v1.5h1v4c0,0.83,0.67,1.5,1.5,1.5 h2c0.83,0,1.5-0.67,1.5-1.5v-4h1V10z" opacity=".3"/>
