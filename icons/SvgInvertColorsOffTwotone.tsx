// /src/communication/invert_colors_off/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgInvertColorsOffTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M12,14.83L12,19c-3.31,0-6-2.63-6-5.87c0-1.19,0.36-2.32,1.02-3.28L12,14.83z M12,4.81l0,4.37l-2.2-2.2 L12,4.81" opacity=".3"/>
