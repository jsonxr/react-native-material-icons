// /src/communication/document_scanner/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDocumentScannerTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M7,6v12h10V6H7z M15,16H9v-2h6V16z M15,13H9v-2h6V13z M15,10H9V8h6V10z" opacity=".3"/>
