// /src/maps/plumbing/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPlumbingSharp = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <rect height="3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -6.2383 8.9393)" width="5" x="5.17" y="10.5"/>
