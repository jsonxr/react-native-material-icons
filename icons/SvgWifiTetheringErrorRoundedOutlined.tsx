// /src/device/wifi_tethering_error_rounded/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgWifiTetheringErrorRoundedOutlined = createSvgIcon(
