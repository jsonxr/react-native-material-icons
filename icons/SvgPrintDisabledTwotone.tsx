// /src/communication/print_disabled/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPrintDisabledTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    ...
    <path d="M18 15.01l2-.01v-4c0-.55-.45-1-1-1h-6.34l3 3H18v2.01zm-1-3.5c0-.55.45-1 1-1s1 .45 1 1-.45 1-1 1-1-.45-1-1z" opacity=".3"/>
    <circle cx="18" cy="11.51" r="1"/>
    <path d="M16 5H8v.35L10.66 8H16z" opacity=".3"/>
