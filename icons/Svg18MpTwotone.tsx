// /src/image/18mp/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const Svg18MpTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect height="1.5" opacity=".3" width="1.5" x="13.5" y="6.5"/>
        <rect height="1.5" opacity=".3" width="1.5" x="13.5" y="9"/>
        ...
        <path d="M13,11.5h2.5c0.55,0,1-0.45,1-1v-4c0-0.55-0.45-1-1-1H13c-0.55,0-1,0.45-1,1v4C12,11.05,12.45,11.5,13,11.5z M13.5,6.5H15 V8h-1.5V6.5z M13.5,9H15v1.5h-1.5V9z"/>
      </g>
    </g>
  </svg>`
);
