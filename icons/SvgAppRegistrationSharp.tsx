// /src/communication/app_registration/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgAppRegistrationSharp = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <rect height="3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -2.481 17.1312)" width="2" x="18.44" y="10.06"/>
      </g>
    </g>
  </svg>`
);
