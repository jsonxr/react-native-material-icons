// /src/social/group_add/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgGroupAddTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M8,15c-2.7,0-5.8,1.29-6,2.01V18h12v-1C13.8,16.29,10.7,15,8,15z" enable-background="new" opacity=".3"/>
        <circle cx="8" cy="8" enable-background="new" opacity=".3" r="2"/>
