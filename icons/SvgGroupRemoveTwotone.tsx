// /src/social/group_remove/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgGroupRemoveTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" height="24" width="24"/>
    <path d="M8,10c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2S9.1,10,8,10z M14,18H2v-0.99C2.2,16.29,5.3,15,8,15s5.8,1.29,6,2 V18z" opacity=".3"/>
