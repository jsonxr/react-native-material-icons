// /src/device/signal_wifi_statusbar_connected_no_internet_4/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSignalWifiStatusbarConnectedNoInternet4Round = createSvgIcon(
