// /src/maps/dry_cleaning/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDryCleaningTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect enable-background="new" height="5" opacity=".3" width="6" x="9" y="15"/>
