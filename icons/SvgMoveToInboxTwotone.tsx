// /src/content/move_to_inbox/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMoveToInboxTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0z" fill="none"/>
    <path d="M12.01 18c-1.48 0-2.75-.81-3.45-2H5v3h14v-3h-3.55c-.69 1.19-1.97 2-3.44 2z" opacity=".3"/>
