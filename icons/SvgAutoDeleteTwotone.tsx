// /src/alert/auto_delete/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgAutoDeleteTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M12,7H4v10h5.08C9.03,16.67,9,16.34,9,16c0-2.38,1.19-4.47,3-5.74V7z" opacity=".3"/>
