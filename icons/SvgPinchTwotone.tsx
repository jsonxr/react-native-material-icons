// /src/action/pinch/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgPinchTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <rect fill="none" height="24" width="24"/>
    </g>
    <g>
      <path d="M21,15.56l-4.24-1.89H15V7.5C15,7.22,14.78,7,14.5,7S14,7.22,14,7.5v10.61l-4.17-0.89l3.7,3.78h6.55 L21,15.56z" opacity=".3"/>
