// /src/social/heart_broken/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgHeartBrokenTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M9.23,5.42C8.69,5.15,8.09,5,7.5,5C5.54,5,4,6.54,4,8.5c0,2.5,2.45,4.84,6.24,8.23L10.77,12H7.35L9.23,5.42 z" opacity=".3"/>
        <path d="M16.5,5c-0.37,0-0.75,0.06-1.12,0.18L14.77,7h2.91l-2.56,8.53C17.98,12.93,20,10.71,20,8.5 C20,6.54,18.46,5,16.5,5z" opacity=".3"/>
