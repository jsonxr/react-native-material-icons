// /src/places/stroller/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgStrollerTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <g>
      <rect fill="none" height="24" width="24"/>
      <path d="M10,5c0.29,0,0.58,0.02,0.86,0.05L9.49,6.66l-1.4-1.4C8.71,5.09,9.35,5,10,5 M15,8.66V15H9.6L15,8.66" opacity=".3"/>
