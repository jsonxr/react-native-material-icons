// /src/notification/directions_off/materialicons/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDirectionsOff = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <rect height="7.07" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -3.0134 12.8107)" width="1.54" x="13.19" y="6.51"/>
      </g>
    </g>
  </svg>`
);
