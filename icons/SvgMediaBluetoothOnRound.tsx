// /src/device/media_bluetooth_on/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMediaBluetoothOnRound = createSvgIcon(
