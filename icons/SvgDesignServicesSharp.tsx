// /src/maps/design_services/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDesignServicesSharp = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      ...
      <g>
        ...
        <rect height="5.3" transform="matrix(0.7071 -0.7071 0.7071 0.7071 1.302 14.5981)" width="3.59" x="16.48" y="3.08"/>
      </g>
    </g>
  </svg>`
);
