// /src/maps/dinner_dining/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDinnerDiningTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <path d="M17.08,15.14C16.41,14.4,15.49,14,14.5,14c-1.35,0-2.58,0.79-3.16,2h6.32 C17.52,15.69,17.32,15.4,17.08,15.14z" enable-background="new" opacity=".3"/>
