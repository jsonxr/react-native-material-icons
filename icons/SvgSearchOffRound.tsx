// /src/action/search_off/materialiconsround/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgSearchOffRound = createSvgIcon(
