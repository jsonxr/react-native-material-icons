// /src/maps/liquor/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgLiquorTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <rect height="1" opacity=".3" width="1" x="16" y="4"/>
        <path d="M6,15c0.55,0,1-0.45,1-1v-1H5v1C5,14.55,5.45,15,6,15z" opacity=".3"/>
        <rect height="2" opacity=".3" width="7" x="13" y="14"/>
