// /src/maps/local_shipping/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgLocalShippingTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
    <path d="M0 0h24v24H0V0z" fill="none"/>
    <path d="M3 15h.78c.55-.61 1.34-1 2.22-1s1.67.39 2.22 1H15V6H3v9z" opacity=".3"/>
