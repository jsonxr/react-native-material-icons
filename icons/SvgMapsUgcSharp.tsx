// /src/maps/maps_ugc/materialiconssharp/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgMapsUgcSharp = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    <rect fill="none" fill-rule="evenodd" height="24" width="24" y="0"/>
    <g>
    ...
    <polygon fill-rule="evenodd" points="13,8 11,8 11,11 8,11 8,13 11,13 11,16 13,16 13,13 16,13 16,11 13,11"/>
  </svg>`
);
