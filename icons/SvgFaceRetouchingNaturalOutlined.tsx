// /src/image/face_retouching_natural/materialiconsoutlined/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgFaceRetouchingNaturalOutlined = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        ...
        <polygon points="23,4.5 20.6,3.4 19.5,1 18.4,3.4 16,4.5 18.4,5.6 19.5,8 20.6,5.6"/>
      </g>
    </g>
  </svg>`
);
