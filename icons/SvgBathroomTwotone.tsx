// /src/search/bathroom/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgBathroomTwotone = createSvgIcon(
