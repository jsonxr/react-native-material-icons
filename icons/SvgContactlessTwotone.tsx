// /src/action/contactless/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgContactlessTwotone = createSvgIcon(
