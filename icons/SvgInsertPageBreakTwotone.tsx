// /src/editor/insert_page_break/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgInsertPageBreakTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <polygon opacity=".3" points="18,11 6,11 6,4 13,4 13,9 18,9"/>
        <g>
        ...
        <rect height="3" opacity=".3" width="12" x="6" y="17"/>
      </g>
    </g>
  </svg>`
);
