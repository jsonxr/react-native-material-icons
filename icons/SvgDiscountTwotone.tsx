// /src/device/discount/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgDiscountTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g>
        <g opacity=".3">
          <path d="M19,9.79L11.21,2H5v6.21L12.79,16L19,9.79z M7.25,5.5C6.56,5.5,6,4.94,6,4.25S6.56,3,7.25,3S8.5,3.56,8.5,4.25 S7.94,5.5,7.25,5.5z"/>
        </g>
