// /src/file/cloud_sync/materialiconstwotone/24px.svg
import { createSvgIcon } from './createSvgIcon';

export const SvgCloudSyncTwotone = createSvgIcon(
  `<svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
    ...
    <g>
      <g opacity=".3">
        <path d="M21.51,18L21.51,18L15,18c-0.55,0-1-0.45-1-1s0.45-1,1-1h1.25v-0.25c0-0.97,0.78-1.75,1.75-1.75s1.75,0.78,1.75,1.75V17 c0,0,1.75,0,1.76,0c0.28,0,0.5,0.22,0.5,0.5C22,17.77,21.78,18,21.51,18z"/>
      </g>
      <g>
